...
void LcdInit ( void )
{
    ...
    */
    ...
    LcdSend( 0xC8, LCD_CMD ); /* Set LCD Vop (Contrast).c8*/
    LcdSend( 0x06, LCD_CMD ); /* Set Temp coefficent. 06*/
    LcdSend( 0x13, LCD_CMD ); /* LCD bias mode 1:48. 13*/
